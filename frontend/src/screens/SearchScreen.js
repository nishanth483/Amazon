...
//     const page = sp.get('page')||1;// based on the url it will fetch ata
...
//     `https://amazonbackend-kappa.vercel.app/api/products/search?page=${page}&query=${query}&category=${category}&price=${price}&rating=${rating}&order=${order}`
//   );
